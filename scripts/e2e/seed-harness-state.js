...
const ALERT = ['trg_z_alert_champion_revealed', 'trg_z_alert_ko_phase_opens', 'trg_z_alert_match_status', 'trg_z_alert_orphan_predictions', 'trg_z_alert_result_confirmed', 'trg_z_alert_result_corrected', 'trg_z_alert_unresolved_slots'];
